...
--
-- Host: localhost
-- Generation Time: Oct 15, 2013 at 02:30 AM
...
CREATE TABLE IF NOT EXISTS `tbl_ills_items` (
  ...
  `ill_ite_ill_ite_dim_id` int(11) NOT NULL,
...
INSERT INTO `tbl_ills_items` (`ill_ite_id`, `ill_ite_ill_id`, `ill_ite_name`, `ill_ite_description`, `ill_ite_ill_ite_dim_id`, `ill_ite_value_male`, `ill_ite_value_female`, `ill_ite_dateCreated`, `ill_ite_dateModified`, `ill_ite_status`) VALUES
(1, 4, 'GB', '', 2, '3.5-10', '3.5-10', '2013-09-10 10:33:34', '2013-10-14 20:26:07', b'1'),
(2, 6, 'GR', '', 2, '3.50-5.50', '3.50-5.50', '2013-09-10 10:46:58', '2013-10-14 20:26:10', b'1'),
(3, 3, 'Hb', '', 2, '11.5-16.5', '11.5-16.5', '2013-09-10 10:47:23', '2013-10-14 20:50:20', b'1'),
(4, 4, 'GVR', '', 4, '2.5-11', '2-10.5', '2013-10-13 16:56:44', '2013-10-14 20:26:14', b'1'),
(5, 11, 'AAHA-1', '', 4, '1-10', '2-11', '2013-10-13 16:57:34', '2013-10-14 20:26:16', b'1'),
(6, 11, 'AAHA-2', '', 2, '1-10', '2-11', '2013-10-13 16:57:45', '2013-10-14 20:26:20', b'1'),
(7, 11, 'AAHA-3', '', 2, '1-10', '2-11', '2013-10-13 16:57:49', '2013-10-14 20:26:23', b'1'),
(8, 3, 'test-1', '', 4, '10-22', '11-20', '2013-10-14 20:02:31', NULL, b'1');
...
--
-- Table structure for table `tbl_ills_items_dimentions`
--

CREATE TABLE IF NOT EXISTS `tbl_ills_items_dimentions` (
  `ill_ite_dim_id` int(11) NOT NULL AUTO_INCREMENT,
  `ill_ite_dim_value` text COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`ill_ite_dim_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=9 ;

--
-- Dumping data for table `tbl_ills_items_dimentions`
--

INSERT INTO `tbl_ills_items_dimentions` (`ill_ite_dim_id`, `ill_ite_dim_value`) VALUES
(2, 'U/L'),
(3, '∛'),
(8, '¾');
...
(4, NULL, 'SOK', 'Chumnou', 'm', 55, 0, '', '2013-09-06 17:41:49', '2013-10-14 20:57:32', b'1'),
(5, 6, 'SENG', 'Rathana', 'm', 50, 0, '', '2013-09-06 17:41:49', '2013-10-14 20:57:38', b'1'),
(9, NULL, 'CHEA', 'Dararith', 'm', 70, NULL, NULL, '2013-09-06 17:47:44', '2013-10-14 20:57:44', b'1'),
(10, 6, 'SUON', 'Dara', 'f', 45, 1222328839, '', '2013-09-19 11:42:15', '2013-10-14 20:57:52', b'1'),
(11, NULL, 'SENG', 'Dara', 'm', 33, 990099878, '', '2013-09-22 09:35:31', '2013-10-14 20:57:58', b'1'),
(12, NULL, 'SOU', 'Sopheap', 'm', 22, 0, '', '2013-09-22 09:37:17', '2013-10-14 20:58:03', b'1'),
(13, NULL, 'SRENG', 'Sokneath', 'm', 25, 899899989, '', '2013-09-22 09:42:49', '2013-10-14 20:58:07', b'1'),
(14, NULL, 'Vannak', 'PEN', 'm', 44, 10681635, 'vannakpen@gmail.com', '2013-10-10 15:27:49', '2013-10-14 20:58:11', b'1');
...
-- Error reading data: (#1356 - View 'db_laboratory.vie_ills_items' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
...
,`pat_tes_id` int(11)
,`ill_ite_dim_id` int(11)
,`ill_ite_dim_value` text
);
-- --------------------------------------------------------
